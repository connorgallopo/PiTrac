...
def test_config_manager():
    ...
    with tempfile.TemporaryDirectory() as tmpdir:
        ...
        success, message, restart = config_manager.set_config("gs_config.cameras.kCamera2Gain", "8.0")
        ...
        # Test 7: Get diff
        config_manager.user_settings = {"gs_config": {"cameras": {"kCamera1Gain": "3.0"}}}
