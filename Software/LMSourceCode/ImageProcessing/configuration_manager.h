...
private:
     ...
     */
    template<typename T>
    void SetInTree(boost::property_tree::ptree& tree, const std::string& path, const T& value);
};
...
template<typename T>
void ConfigurationManager::SetInTree(boost::property_tree::ptree& tree, const std::string& path, const T& value) {
    tree.put(path, value);
}
